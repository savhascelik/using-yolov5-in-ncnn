...
public class Overlay extends View {
    private com.savhascelik.exampleyolov5withncnn.NCNNDetector.Obj[] objects=null;
    ...
    public void drawRects(com.savhascelik.exampleyolov5withncnn.NCNNDetector.Obj[] rects){
        this.objects=rects;
        this.invalidate();
    }
}
